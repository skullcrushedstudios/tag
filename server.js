...
class Game {
  ...
  addPlayer(socketId, playerData) {
    ...
    const player = {
      ...
      x:
        playerCount === 0
          ? this.gameState.gameWidth / 4
          : (this.gameState.gameWidth * 3) / 4,
  ...
  checkTagging() {
    ...
    // Improved AABB collision detection with hitbox tolerance
    const hitboxSize = this.gameState.playerSize * 0.9; // Slightly tighter hitbox
    const tolerance = 5; // Extra pixels for better feel
